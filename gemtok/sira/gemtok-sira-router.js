(function () {
  var PAGES = {
    ...
    welcome: "panel.html",
    account: "hesap.html",
    subscription: "abonelik.html",
    security: "guvenlik.html",
    integrations: "entegrasyonlar.html",
    gifts: "hediyeler.html",
    terms: "kullanim-sartlari.html",
    privacy: "gizlilik-politikasi.html",
    server: "sunucu-degistir.html",
    admin: "admin.html",
    giftHub: "hediye-yonetimi.html",
    /** Oyunlar: WarFront, Arena Battle, … — vitrin listesi `buildHomeShowcaseGames` (en fazla 10). */
    menu: "menu.html",
  };

  /** `sira/*.html` sayfasından `../game/...` yolunu tam URL yapar (https, alt klasör, `file://`). */
  ...
  function renderAdminLicenseBlock() {
    ...
    regExport.setAttribute(
      "title",
      "GitHub: sira/gemtok-license-registry.json dosyasını repoya ekleyin; ziyaretçiler anahtar doğrulayabilir.",
    );
    ...
    regHint.textContent =
      "Canlı sitede anahtar ürettiğinizde sunucu API varsa otomatik kaydedilir. Statik GitHub yayınında Sunucu kaydı indir ile sira/gemtok-license-registry.json dosyasını repoya ekleyip yeniden yayınlayın.";
      ...
      function (ev) {
        ...
        if (expReg === "1") {
          ...
          if (window.GemtokLicense.downloadServerRegistryFile()) {
            setAdminLicenseFeedback(
              "gemtok-license-registry.json indirildi - sira/ klasörüne ekleyip GitHub yayınına gönderin.",
              "ok",
            );
          } else {
