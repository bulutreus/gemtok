...
import { isOfflinePlayMode, isStandaloneFileMode } from './standaloneMode.js';
...
export default function App() {
  ...
  const offlineMode = isOfflinePlayMode();
  ...
  useEffect(() => {
    if (!offlineMode || !config) return undefined;
    let cancelled = false;
    const b = bundledGameConfig;
  ...
  }, [offlineMode, config, columnGifts]);
  ...
  useEffect(() => {
    ...
    return undefined;
  }, [offlineMode, config, columnGifts, catalogGifts]);
  ...
  const simulate = useCallback(
    ...
    [offlineMode, columnGifts, ingestGameGift]
  );
