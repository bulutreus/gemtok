...
Kök `sıra/`, `game/` ve `gemtok-game-license-gate.js` dosyalarını GitHub yayınına dahil edin. Yönetici panelinde sunucu parolası alanına `GEMTOK_LICENSE_ADMIN_SECRET` değerini girin. Yeni anahtar üretildiğinde yalnızca yeni anahtar o anda gösterilir; kaybedilen anahtar sunucudan geri okunamaz.
